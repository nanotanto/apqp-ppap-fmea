...
import EditActionView from "views/p-fmea/edit_action";
...
export default class OptimizationView extends JetView{
                    ...
                    "rows": [
                        ...
                        },
                        {
                            ...
                            scheme:{
                                $change:function(item){
                                    ...
                                    } else if (item.ap == 'Medium'){
                                        item.$css = { "background-color":"#FFF59E" }
                                    }
                        ...
                        },
                        {
                            ...
                            "cols": [
                                ...
                                { id:"btn_edit_action", "view": "button", "label": "Edit", "autowidth": true, "css": "webix_primary", disabled:true, 
                                    click:()=> this.winEditAction.showWindow()
                                },
                                { id:"btn_add_action", "view": "button", "label": "Add", "autowidth": true, "css": "webix_primary", disabled:true, 
                        ...
                        },
                        {
                            ...
                            on:{
                                "onAfterSelect":function(id){
                                    $$("btn_edit_action").enable();   
                                    $$('form_action2').clear();
                                    $$('form_action2').load('actions/'+id)  
                                }
                            },
                            // editable:true,
                            // editaction:"dblclick",
                                ...
                                "wxi-trash":function(event, id, node){
                                    webix.confirm("Are you sure want to delete data ?").then(function(result){
                                        webix.ajax().
                                            ...
                                            post("actions/delete/"+id).then(() => {
                                                webix.message("Deleted");
                                                $$("tbl_action").remove(id);
                                                $$("tbl_action").clearAll();     
                                                var current = $$("tbl_currents_all").getSelectedId();
                                                $$("tbl_action").load("actions/show/"+current); 
                                            }); 
                                    });
                                }
                            }
    ...
    init(){
        ...
        this.winEditAction = this.ui(EditActionView); 
    }
}