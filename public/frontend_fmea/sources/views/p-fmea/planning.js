                            ...
                            "cols": [
                                ...
                                },
                                {
                                    "rows": [
                                        ...
                                        {
                                            cols:[
                                                { name:"start_date","label": "P-FMEA Start Date",  "view": "datepicker", "labelPosition": "top"},
                                                { name:"revision_date","label": "P-FMEA Revision Date",  "view": "datepicker", "labelPosition": "top" },
                                            ]
                                        },
                                                ...
                                                click:function(){
                                                    ...
                                                    if (form.validate()){
                                                        ...
                                                        webix.confirm("Do you wont to edit data ?").then(function(result){
                                                            ...
                                                            put("products/update/"+id, data).then(() => webix.message("Edited"));
                                                            //$$("btn_edit").disable();
                                                        });
