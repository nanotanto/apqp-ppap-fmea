...
import EditFailureView from "views/p-fmea/edit_failure";
...
export default class ModeView extends JetView{
                            ...
                            "rows": [
                                {
                                    ...
                                    "cols": [
                                        ...
                                        { id:"btn_edit_mode","view": "button", "label": "Edit", "autowidth": true, "css": "webix_primary", disabled:true,
                                            click:()=> {
                                                var id = $$("tbl_mode").getSelectedId();
                                                $$("form_mode2").load("modes/view/"+id);
                                                this.winEditFailure.showWindow();
                                            }
                                        },
                                        { id:"btn_add","view": "button", "label": "Add", "autowidth": true, "css": "webix_primary", disabled:true,
                                        ...
                                        "wxi-trash":function(event, id, node){
                                            webix.confirm("Are you sure want to delete data ?").then(function(result){
                                                webix.ajax().
                                                    ...
                                                    post("modes/delete/"+id).then(() => {
                                                        webix.message("Deleted")
                                                        $$("tbl_mode").remove(id);
                                                        $$("tbl_mode").clearAll();   
                                                        var process_step = $$("tbl_process_step2").getSelectedId();
                                                        $$("tbl_mode").load("modes/show/"+process_step);
                                                    });
                                            });
                                        }
                                    },
    ...
    init(){
        ...
        this.winEditFailure = this.ui(EditFailureView);  
    }
}