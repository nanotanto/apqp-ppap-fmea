...
import EditConditionView from "views/p-fmea/edit_condition";
...
export default class RiskView extends JetView{
                    ...
                    "rows": [
                        ...
                        },
                        {
                            ...
                            "cols": [
                                ...
                                { id:"btn_edt_current","view": "button", "label": "Edit", "autowidth": true, "css": "webix_primary", disabled:true, 
                                    click:()=>{
                                        this.winEditCondition.showWindow();
                                    } 
                                },
                                { id:"btn_add_current","view": "button", "label": "Add", "autowidth": true, "css": "webix_primary", disabled:true, 
                                ...
                                "wxi-trash":function(event, id, node){
                                    webix.confirm("Are you sure want to delete data ?").then(function(result){
                                        webix.ajax().
                                            ...
                                            post("currents/delete/"+id).then(() => {
                                                webix.message("Deleted");
                                                $$("tbl_current").remove(id);
                                                $$("tbl_current").clearAll();     
                                                var mode_id = $$("tbl_modes_all").getSelectedId();
    ...
    init(){
        ...
        this.winEditCondition = this.ui(EditConditionView);  
    }
}