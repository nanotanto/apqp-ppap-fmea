		                            ...
		                            webix.confirm({
		                                ...
		                                callback: res => {              
		                                    ...
		                                    if (res){
		                                        ...
		                                        webix.ajax().del("../api/documents/"+id);
								...
								"rows": [
									...
									},
									{
										"cols": [
											{
												"rows": [
													...
													// 				{ name:"user_id", "options": user, "view": "combo", disabled:true, id:"user_id" },
													// 				// { "label": "Add", "view": "button", "height": 0, "width": 50, "name": "add", css:"webix_primary",
													// 				// 	click:()=>{
									    ...
									    //     //                             }
													...
													// 		// { "view": "button", "label": "Send", "autowidth": true, "name": "send", css:"webix_secondary ",
													// 		// 	click:()=>{
