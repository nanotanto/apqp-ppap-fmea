...
<small>
<small>
<table style="text-align: left; border-collapse: collapse; width: 100%;" border="1" cellpadding="2" cellspacing="2">
  <tbody>
    <tr>
...
(Step 6)</td>
    ...
    <tr>
      <td style="vertical-align: top; text-align: center; width: 34px; writing-mode: tb-rl;">Isuue#</td>
...
Failure Effects (FE) to the Next Higher Level Element and/or End User</td>
      <td style="vertical-align: top; text-align: center; width: 20px; background-color: rgb(51, 204, 0);">(S)</td>
      <td style="vertical-align: top; text-align: center; width: 200px; background-color: rgb(204, 255, 255);">2.
...
Prevention Control (PC) of FC</td>
      <td style="vertical-align: top; text-align: center; width: 20px; background-color: rgb(51, 204, 0);">(O)</td>
      <td style="vertical-align: top; text-align: center; width: 200px; background-color: rgb(51, 204, 0);">Current
Detection Controls (DC) of FC or FM</td>
      <td style="vertical-align: top; text-align: center; width: 20px; background-color: rgb(51, 204, 0);">(D)</td>
      <td style="vertical-align: top; text-align: center; width: 20px; background-color: rgb(51, 204, 0);">AP</td>
      <td style="vertical-align: top; text-align: center; width: 20px; background-color: rgb(51, 204, 255); writing-mode: tb-rl; ">Spec.
Char.</td>
      <td style="vertical-align: top; text-align: center; width: 20px; writing-mode: tb-rl;">Filtercode
(Optional)</td>
...
@foreach ($datas as $item)    
    ...
    <td style="vertical-align: top;"><br>
      ...
      <td style="vertical-align: top;">Your Plant: {{$item->process_function}}<br>Ship to Plant: {{$item->process_function2}}<br>End User: {{$item->process_function3}}
      </td>
      ...
      <td style="vertical-align: top;">Your Plant: {{$item->effect_in}}<br>Ship to Plant: {{$item->effect_next}}<br>End User: {{$item->effect_end}}<br>
      </td>
