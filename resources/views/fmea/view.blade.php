...
<tr style="height: 18px;">
<td style="width: 25%; height: 18px;">&nbsp;{{ $product->user->name }}</td>
<td style="width: 25%; height: 18px;">&nbsp;{{ $product->user->position->name }}</td>
<td style="width: 25%; height: 18px;">&nbsp;{{ $product->created_at }}</td>
</tr>
<tr style="height: 18px;">
